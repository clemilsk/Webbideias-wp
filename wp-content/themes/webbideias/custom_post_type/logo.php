...
function custom_post_type_logo() {
	...
	$labels = array(
		'name'                  => _x( 'Logo Principal', 'Logo Principal', 'text_domain' ),
		'singular_name'         => _x( 'Logo', 'Logo', 'text_domain' ),
		'menu_name'             => __( 'Logo Principal', 'text_domain' ),
		...
		'featured_image'        => __( 'Logo principal', 'text_domain' ),
	...
	$args = array(
		...
		'description'           => __( 'Logo Description', 'text_domain' ),
		'labels'                => $labels,
